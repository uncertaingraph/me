...
<BUTTON ONCLICK="ShowAndHide()">Abstract</BUTTON>
<DIV ID="SectionName" STYLE="display:none; padding: 2px; border: 1px solid gray;"><i>"Testing 123"</i></DIV>
</div><br>
